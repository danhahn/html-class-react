...
[attribute&vert;=value]|[lang&vert;=en]|Selects all elements with a lang attribute value starting with "en"|2
...
table:first-of-type tr td:nth-child(3) {width: 70%}
table:first-of-type tr td:nth-child(4) {width: 20px}
